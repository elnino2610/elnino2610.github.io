...
const log = __webpack_require__(56).getLogger('webpack-dev-server');
const socket = __webpack_require__(60);
const overlay = __webpack_require__(59);
...
const onSocketMsg = {
  ...
  'log-level': function logLevel(level) {
    const hotCtx = __webpack_require__(62);
...
function reloadApp() {
  ...
  if (hot) {
    ...
    const hotEmitter = __webpack_require__(61);
...
var map = {
	"./abstracts/_extends.scss": 42,
	"./abstracts/_functions.scss": 43,
	"./abstracts/_mixins.scss": 44,
	"./abstracts/_variables.scss": 45,
	"./base/_base.scss": 1,
	"./base/_typography.scss": 2,
	"./layouts/_layout.scss": 46,
	"./layouts/blank.scss": 47
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
...
module.exports = __webpack_require__.p + "_blank.html";
...
var require;var require;/* sockjs-client v1.1.4 | http://sockjs.org | MIT license */
...
const ansiHTML = __webpack_require__(51);
const Entities = __webpack_require__(53).AllHtmlEntities;
...
const SockJS = __webpack_require__(57);
